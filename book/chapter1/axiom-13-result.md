...
Twelve axioms in, Result is the first place all the pieces fit into one diagram. The sketch above shows the shape of the type; the worked example below shows the shape those twelve axioms together push the *code* into.
